...
module.exports = {
    ...
    run: async (client, interaction, lang) => {
        try {
            const supportServerLink = "https://discord.gg/56uzCcbVDs";
            const githubLink = "https://github.com/lstrxx1top";
            const replitLink = "https://replit.com/@latexx1top";
            const youtubeLink = "https://www.youtube.com/@latexx1top";
